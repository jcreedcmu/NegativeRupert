...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [1114112, 1119311) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v7.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v7.csv" from 1114112 to 1119311 chunkSize 512
